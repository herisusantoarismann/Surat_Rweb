        ...
        <div class="relative w-5/6 h-screen bg-gray-100">
            ...
            <div class="m-16 px-8 py-2 bg-white">
                <div class="flex flex-row justify-between items-center py-4">
                    <h3 class="text-xl font-semibold">Edit Data Dosen</h3>
                </div>
                ...
                <form action="<?= base_url().'index.php/dosen/update' ?>" method="post"
                    ...
                    <div class="w-2/5 flex flex-col mb-6">
                        ...
                        <input type="text" name="nama" placeholder="Nama" value="<?= $d->nama ?>"
                            class="border-2 border-gray p-2 rounded focus:outline-none focus:ring-1 focus:border-blue-300">
                    </div>
                    <div class="w-2/5 flex flex-col mb-6">
                        <h5>NIM</h5>
                        <input type="text" name="niy" placeholder="NIY" value="<?= $d->niy ?>"
                            class="border-2 border-gray p-2 rounded focus:outline-none focus:ring-1 focus:border-blue-300">
                    </div>
                    <div class="w-2/5 flex flex-col mb-6">
                        <h5>Semester</h5>
                        <input type="text" name="keahlian" placeholder="Keahlian" value="<?= $d->keahlian ?>"
                            class="border-2 border-gray p-2 rounded focus:outline-none focus:ring-1 focus:border-blue-300">
                    </div>
                    <div class="w-2/5 flex flex-col mb-6">
                        <h5>Email</h5>
                        <input type="email" name="email" placeholder="Email" value="<?= $d->email ?>"
                            class="border-2 border-gray p-2 rounded focus:outline-none focus:ring-1 focus:border-blue-300">
                    </div>
                    <button type="submit"
